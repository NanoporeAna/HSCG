...
class GCN(nn.Module):
    def __init__(self, num_layer=5, emb_dim=300, feat_chang_dim=512, feat_dim=768, drop_ratio=0, pool='mean'):
        ...
        self.out_lin = nn.Sequential(
            nn.Linear(self.feat_dim, self.feat_chang_dim), 
            nn.ReLU(inplace=True),
            # nn.Softplus(),
            nn.Linear(self.feat_chang_dim, self.feat_dim)
        )
