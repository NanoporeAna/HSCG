...
class evel_smiles_cnmr_dataset_new(Dataset):
    def __init__(self, val_data, have_tags):
        ...
        self.val_data = val_data.to_dict(orient='records')
    ...
    def __getitem__(self, idx):
        current_nmr = self.hsqcs[idx]
        current_val_data = self.val_data[idx]
        ...
        return  current_nmr, current_val_data, current_wt, current_tags
